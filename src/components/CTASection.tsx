  ...
  return (
    <section className="py-32 border-y border-border">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="font-body text-muted-foreground mt-4 mb-10 text-sm">
          Limited pieces available — Once they're gone, they're gone.
        </p>
        <Link
          to="/#products"
          className="inline-flex items-center justify-center h-12 px-10 bg-primary text-primary-foreground font-display text-sm tracking-widest uppercase hover:bg-primary/90 transition-all duration-300"
        >
          Shop the Collection
        </Link>
      </div>
